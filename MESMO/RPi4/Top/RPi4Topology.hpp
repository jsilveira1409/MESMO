// ======================================================================
// \title  RPi4Topology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef RPI4_RPI4TOPOLOGY_HPP
#define RPI4_RPI4TOPOLOGY_HPP
// Included for access to RPi4::TopologyState and RPi4::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <RPi4/Top/RPi4TopologyDefs.hpp>

// Remove unnecessary RPi4:: qualifications
 ...
 * RPi4::TopologyState see: RPi4TopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type RPi4::TopologyState see: RPi4TopologyDefs.hpp.
 *
