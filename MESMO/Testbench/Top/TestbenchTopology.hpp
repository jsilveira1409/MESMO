// ======================================================================
// \title  TestbenchTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef TESTBENCH_TESTBENCHTOPOLOGY_HPP
#define TESTBENCH_TESTBENCHTOPOLOGY_HPP
// Included for access to Testbench::TopologyState and Testbench::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <Testbench/Top/TestbenchTopologyDefs.hpp>

// Remove unnecessary Testbench:: qualifications
 ...
 * Testbench::TopologyState see: TestbenchTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Testbench::TopologyState see: TestbenchTopologyDefs.hpp.
 *
