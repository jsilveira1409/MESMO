// ======================================================================
// \title  TestbenchTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef TESTBENCH_TESTBENCHTOPOLOGYDEFS_HPP
#define TESTBENCH_TESTBENCHTOPOLOGYDEFS_HPP

#include "Drv/BlockDriver/BlockDriver.hpp"
#include "Fw/Types/MallocAllocator.hpp"
#include "Testbench/Top/FppConstantsAc.hpp"
 ...
 *
 * The topology autocoder requires an object that carries state with the name `Testbench::TopologyState`. Only the type
