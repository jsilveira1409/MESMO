// ======================================================================
// \title  NativeTopologyDefs.hpp
// \brief required header file containing the required definitions for the topology autocoder
//
// ======================================================================
#ifndef NATIVE_NATIVETOPOLOGYDEFS_HPP
#define NATIVE_NATIVETOPOLOGYDEFS_HPP

#include "Drv/BlockDriver/BlockDriver.hpp"
#include "Fw/Types/MallocAllocator.hpp"
#include "Native/Top/FppConstantsAc.hpp"
 ...
 *
 * The topology autocoder requires an object that carries state with the name `Native::TopologyState`. Only the type
