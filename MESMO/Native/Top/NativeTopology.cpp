// ======================================================================
// \title  NativeTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <Native/Top/NativeTopologyAc.hpp>
#include <Native/Top/NativePacketsAc.hpp>
...
void configureTopology() {
    ...
    // tlmSend.setPacketList(NativePacketsPkts, NativePacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name Native
namespace Native {
