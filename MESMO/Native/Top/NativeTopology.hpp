// ======================================================================
// \title  NativeTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef NATIVE_NATIVETOPOLOGY_HPP
#define NATIVE_NATIVETOPOLOGY_HPP
// Included for access to Native::TopologyState and Native::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <Native/Top/NativeTopologyDefs.hpp>

// Remove unnecessary Native:: qualifications
 ...
 * Native::TopologyState see: NativeTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Native::TopologyState see: NativeTopologyDefs.hpp.
 *
