...
#include <Native/Top/NativeTopology.hpp>
...
int main(int argc, char* argv[]) {
    ...
    Native::setupTopology(inputs);
    Native::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    Native::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
